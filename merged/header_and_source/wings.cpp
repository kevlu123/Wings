...
namespace wings {
	...
	static Wg_Obj* abort(Wg_Context* context, Wg_Obj** argv, int argc) {
		WG_EXPECT_ARG_COUNT(0);
		std::abort();
	}
	...
	static Wg_Obj* getcwd(Wg_Context* context, Wg_Obj** argv, int argc) {
		WG_EXPECT_ARG_COUNT(0);
...
namespace wings {
	...
	static Wg_Obj* time(Wg_Context* context, Wg_Obj** argv, int argc) {
		WG_EXPECT_ARG_COUNT(0);
